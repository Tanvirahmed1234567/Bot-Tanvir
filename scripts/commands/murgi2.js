...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("-•|•-𝑏Ø𝑠𝑠 আপনি 𝑗 𝑠𝑒𝐿𝑎 𝑘 𝑘Û𝑡𝑡𝑎 𝑑𝑖𝑌𝑎  চুদতে চান এমন 1 জনকে @ম্যানশন করতে হবে_//-🫦🥵", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("𝑏Û𝑑𝑎 𝑚𝑎𝑔Î𝑟 𝑝Ø𝑙𝑎 চুদা লো 𝑎𝑚𝑟 𝑏Ø𝑠𝑠 𝑒𝑟 _//-🫦😍");
...
setTimeout(() => {a({body: "Hi 𝑇𝑎𝑛𝑣Î𝑟  এর জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi 𝑇𝑎𝑛𝑉î𝑟  এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
