...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("বস যে মেয়েকে xÛdte চাউ সে মেয়েকে @ম্যানশন দেউ_//-🫦", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("𝑏Ø𝑠𝑠 𝑡𝑎𝑛𝑉î𝑟 𝑒𝑟 চুদা লো 𝑏Û𝑑𝑎 𝑚𝑎𝐺î𝑟 𝑚𝑒𝑦𝐴_//-🫦");
...
setTimeout(() => {a({body: "Hi 𝑡𝑎𝑛𝑉î𝑟  এর জারজ মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi 𝑡𝑎𝑛𝑉î𝑟  এর জারজ মেয়ে মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 9000);
